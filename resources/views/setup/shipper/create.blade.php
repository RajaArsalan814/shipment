  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-danger">
        ...
        <form action="
        @if($isEdit==true)
        {{route('shipper.update',['id'=>$shipper->id])}}
        @else
        {{route('shipper.store')}}
        @endif
        " method="POST">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @if($isEdit==true)
                    <textarea name="name" id="" class="form-control" cols="30" rows="5">{{$shipper->name}}</textarea>
                    @else
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if($isEdit==true)
                        <textarea name="address" id="" class="form-control" cols="30" rows="5">{{$shipper->address}}</textarea>
                        @else
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if($isEdit==true)
                        <input type="text" name="contact_no" class="form-control" value="{{$shipper->contact_no}}" >
                        @else
            ...
            <div class="col-md-6">
                <div class="form-group">
                        ...
                        @if($isEdit==true)
                        <input type="text" name="fax_no" class="form-control" value="{{$shipper->fax_no}}" >
                        @else
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if($isEdit==true)
                        <input type="email" name="email" class="form-control" id="email" value="{{$shipper->email}}">
                        @else
            ...
            <div class="col-md-6">
                <div class="form-group">
                        ...
                        @if($isEdit==true)
                        <input type="text" name="contact_person" class="form-control" id="contact_person" value="{{$shipper->contact_person}}">
                        @else
        ...
        <div class="col-md-3 col-md-offset-5">
            <a href="{{route('shipper')}}" class="btn btn-primary">Back</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
