...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
            Shipper
        <small>preview of shipper </small>
      </h1>
      <ol class="breadcrumb">
              ...
              <div class="box-tools">
                <div class="input-group input-group-md hidden-xs col-md-offset-7" style="width: 150px;">
                  ...
                  <div class="input-group-btn">
                    <a href="{{route('shipper.create')}}" class="btn btn-primary ">Create</a>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="{{route('shipper.edit',['id'=>$item->id])}}"> <i class="fa fa-edit edit"> </i> </a> </td>
                </tr>
                @endforeach
              </table>
            </div>
